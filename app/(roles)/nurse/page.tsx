...
export default function NursePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="grid gap-4 bg-slate-900 text-white lg:grid-cols-3">
        <div>
          <p className="text-sm uppercase tracking-wide text-white/70">Missed</p>
          <p className="mt-2 text-3xl font-semibold">{missedAppointments.length}</p>
          <p className="text-sm text-white/70">Auto follow-ups needed</p>
        </div>
        <div>
          <p className="text-sm uppercase tracking-wide text-white/70">Unassigned rides</p>
          <p className="mt-2 text-3xl font-semibold">{unassignedRides.length}</p>
          <p className="text-sm text-white/70">Drivers to dispatch</p>
        </div>
        <div>
          <p className="text-sm uppercase tracking-wide text-white/70">Unconfirmed</p>
          <p className="mt-2 text-3xl font-semibold">{unconfirmedAppointments.length}</p>
          <p className="text-sm text-white/70">Waiting on confirmations</p>
        </div>
      </Card>
