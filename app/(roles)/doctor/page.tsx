...
export default function DoctorPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        <h3 className="text-xl font-semibold text-slate-900">Appointments needing confirmation</h3>
        <p className="mt-2 text-sm text-slate-600">Keep the shared status tracker accurate.</p>
